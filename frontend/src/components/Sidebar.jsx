    ...
    switch (userType) {
      case 'superadmin':
        return [
          ...
          { path: '/superadmin/payment-logs', label: 'Payment Logs', icon: 'M12 8c-1.657 0-3 .895-3 2v6a2 2 0 104 0v-1m2-7h4m0 0v4m0-4l-5 5' },
          { path: '/superadmin/installment-invoice', label: 'Installment Invoice', icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z' },
        ];
      case 'admin':
        return [
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${
                isActive
                  ? 'bg-primary-50 text-primary-700 font-semibold ring-1 ring-inset ring-primary-100'
                  : 'text-gray-700 hover:bg-gray-50'
              }`
            }
          >
            <svg
              className="w-5 h-5 flex-shrink-0 text-gray-500 group-hover:text-gray-700"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
